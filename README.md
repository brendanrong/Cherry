...
[![Download](https://img.shields.io/badge/download-latest-brightgreen?style=flat-square)](https://github.com/brendanrong/Ice/releases/latest)
![Platform](https://img.shields.io/badge/platform-macOS-blue?style=flat-square)
![Requirements](https://img.shields.io/badge/requirements-macOS%2014%2B-fa4e49?style=flat-square)
[![Sponsor](https://img.shields.io/badge/Sponsor%20%E2%9D%A4%EF%B8%8F-8A2BE2?style=flat-square)](https://github.com/sponsors/brendanrong)
[![Website](https://img.shields.io/badge/Website-015FBA?style=flat-square)](https://github.com/brendanrong/Cherry)
[![License](https://img.shields.io/github/license/brendanrong/Ice?style=flat-square)](LICENSE)

> [!NOTE]
> Ice is currently in active development. Some features have not yet been implemented. Download the latest release [here](https://github.com/brendanrong/Ice/releases/latest) and see the roadmap below for upcoming features.

<a href="https://www.buymeacoffee.com/brendanrong" target="_blank">
...
Download the "Ice.zip" file from the [latest release](https://github.com/brendanrong/Ice/releases/latest) and move the unzipped app into your `Applications` folder.
...
```sh
brew install --cask brendanrong-ice
```
