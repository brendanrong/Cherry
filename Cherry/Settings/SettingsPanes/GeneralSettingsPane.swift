...
struct GeneralSettingsPane: View {
    ...
    private var showIceIcon: some View {
        Toggle("Show Cherry icon", isOn: $settings.showIceIcon)
            .annotation("Click to show hidden menu bar items. Right-click to access Cherry's settings.")
    }

    @ViewBuilder
    private var iceIconPicker: some View {
        let labelKey = LocalizedStringKey("Cherry icon")
    ...
    private var useIceBar: some View {
        Toggle("Use Cherry Bar", isOn: $settings.useIceBar)
    ...
    private var iceBarLocationPicker: some View {
        ...
        .annotation {
            ...
            case .dynamic:
                Text("The Cherry Bar's location changes based on context.")
            case .mousePointer:
                Text("The Cherry Bar is centered below the mouse pointer.")
            case .iceIcon:
                Text("The Cherry Bar is centered below the Cherry icon.")
            }
        }
    }
